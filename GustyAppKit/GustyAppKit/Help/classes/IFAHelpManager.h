...
/**
* Help text for section obtained from GustyAppKitHelpLocalizable.strings.
* GustyAppKitHelpLocalizable.strings entry key format:
...
/**
* Help text for property obtained from GustyAppKitHelpLocalizable.strings.
* GustyAppKitHelpLocalizable.strings entry key format at property level:
*   entities.<entityName>.properties.<propertyName>.description
* GustyAppKitHelpLocalizable.strings entry key format at property value level:
...
/**
* Help text for empty list obtained from GustyAppKitHelpLocalizable.strings.
* GustyAppKitHelpLocalizable.strings entry key format:
...
/**
* Help text for view controllers obtained from GustyAppKitHelpLocalizable.strings.
...
/**
* Provides the key prefix used for persistent entity related entries in GustyAppKitHelpLocalizable.strings.
