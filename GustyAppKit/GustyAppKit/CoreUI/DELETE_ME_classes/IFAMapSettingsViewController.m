...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.mapTypeSegmentedControl setTitle:NSLocalizedStringFromTable(@"Standard", @"GustyAppKitLocalizable", nil)
                         forSegmentAtIndex:[self IFA_segmentIndexFromMapType:MKMapTypeStandard]];
    [self.mapTypeSegmentedControl setTitle:NSLocalizedStringFromTable(@"Hybrid", @"GustyAppKitLocalizable", nil)
                         forSegmentAtIndex:[self IFA_segmentIndexFromMapType:MKMapTypeHybrid]];
    [self.mapTypeSegmentedControl setTitle:NSLocalizedStringFromTable(@"Satellite", @"GustyAppKitLocalizable", nil)
