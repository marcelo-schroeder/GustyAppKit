...
//        _noDataPlaceholderAddHintPrefixLabel.backgroundColor = [UIColor orangeColor];
        ...
        _noDataPlaceholderAddHintPrefixLabel.text = NSLocalizedStringFromTable(@"Tap ", @"GustyAppKitLocalizable", nil);
    }
...
//        _noDataPlaceholderAddHintSuffixLabel.backgroundColor = [UIColor orangeColor];
        ...
        NSString *l_textTemplate = NSLocalizedStringFromTable(@" to add %@ %@", @"GustyAppKitLocalizable", nil);
