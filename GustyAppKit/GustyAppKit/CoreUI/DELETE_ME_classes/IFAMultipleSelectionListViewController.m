...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
	return section==k_sectionSelectedObjects ? NSLocalizedStringFromTable(@"Selected", @"GustyAppKitLocalizable", nil) : NSLocalizedStringFromTable(@"Available for selection", @"GustyAppKitLocalizable", nil);
}

- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section {
	if (section == k_sectionSelectedObjects) {
		return [self.IFA_selectedDestinationEntities count] ? nil : NSLocalizedStringFromTable(@"No selected entries", @"GustyAppKitLocalizable", nil);
	}
	else {
		return [self.IFA_unselectedDestinationEntities count] ? nil : NSLocalizedStringFromTable(@"No entries available for selection", @"GustyAppKitLocalizable", nil);
	}
}
