...
+ (void) showAlertWithMessage:(NSString*)aMessage title:(NSString*)aTitle delegate:(id)aDelegate buttonLabel:(NSString*)aButtonLabel tag:(NSInteger)aTag{
	UIAlertView* alert = [[UIAlertView alloc] initWithTitle:aTitle message:aMessage
												   delegate:aDelegate
										  cancelButtonTitle:(aButtonLabel==nil?NSLocalizedStringFromTable(@"Continue", @"GustyAppKitLocalizable", nil):aButtonLabel)
...
+ (void) showActionSheetWithMessage:(NSString*)aMessage 
	...
	UIActionSheet *actionSheet = 
		[[UIActionSheet alloc] initWithTitle:aMessage
									delegate:aDelegate 
						   cancelButtonTitle:[NSLocalizedStringFromTable(@"No", @"GustyAppKitLocalizable", nil) stringByAppendingString:(aCancelButtonLabelSuffix?[NSString stringWithFormat:@", %@", aCancelButtonLabelSuffix]:@"")]
					  destructiveButtonTitle:[NSLocalizedStringFromTable(@"Yes, ", @"GustyAppKitLocalizable", nil) stringByAppendingString:aDestructiveButtonLabelSuffix]
						   otherButtonTitles:nil];
...
//			barButtonItem.accessibilityLabel = @"Add Button";
		...
		case IFABarButtonItemTypeSelectNone:
		{
            ...
            if (!l_title) {
                l_title = NSLocalizedStringFromTable(@"Select None", @"GustyAppKitLocalizable", nil);
            }
...
//			barButtonItem.accessibilityLabel = @"Select None Button";
		...
		{
			NSString *l_title = NSLocalizedStringFromTable(@"Select All", @"GustyAppKitLocalizable", nil);
			barButtonItem = [[UIBarButtonItem alloc] initWithTitle:l_title style:UIBarButtonItemStylePlain
                                                            target:a_target action:a_action];
...
//			barButtonItem.accessibilityLabel = @"Next Page Button";
		...
		case IFABarButtonItemTypeSelectNow:
			barButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Now", @"GustyAppKitLocalizable", nil) style:UIBarButtonItemStylePlain
                                                            target:a_target action:a_action];
//			barButtonItem.accessibilityLabel = @"Now Button";
			break;
		case IFABarButtonItemTypeSelectToday:
			barButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Today", @"GustyAppKitLocalizable", nil) style:UIBarButtonItemStylePlain
                                                            target:a_target action:a_action];
...
//			barButtonItem.accessibilityLabel = @"Refresh Button";
		...
		case IFABarButtonItemTypeDismiss:
			barButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Dismiss", @"GustyAppKitLocalizable", nil) style:UIBarButtonItemStylePlain
                                                            target:a_target action:a_action];
//			barButtonItem.accessibilityLabel = @"Dismiss Button";
			break;
		case IFABarButtonItemTypeBack:
			barButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Back", @"GustyAppKitLocalizable", nil) style:UIBarButtonItemStylePlain
                                                            target:a_target action:a_action];
...
+ (NSString*)stringValueForBoolean:(BOOL)aBoolean{
    return aBoolean ? NSLocalizedStringFromTable(@"yes", @"GustyAppKitLocalizable", nil) : NSLocalizedStringFromTable(@"no", @"GustyAppKitLocalizable", nil);
}

+ (NSString*)onOffStringValueForBoolean:(BOOL)aBoolean{
    return aBoolean ? NSLocalizedStringFromTable(@"on", @"GustyAppKitLocalizable", nil) : NSLocalizedStringFromTable(@"off", @"GustyAppKitLocalizable", nil);
}
...
+ (void)showAndHideModeToggleConfirmationHudWithText:(NSString*)a_text on:(BOOL)a_on{
    NSString *format = NSLocalizedStringWithDefaultValue(@"ModeState", @"GustyAppKitLocalizable", [NSBundle bundleForClass:[self class]], @"%@ %@", @"Example: <Adjustment mode> <off>");
...
+ (void)showServerErrorAlertViewForNetworkReachable:(BOOL)a_networkReachable
    ...
    if (a_networkReachable) {
        l_title= NSLocalizedStringFromTable(@"Server error", @"GustyAppKitLocalizable", nil);
        l_messageArgument = NSLocalizedStringFromTable(@" Please try again later.", @"GustyAppKitLocalizable", nil);
    }else{
        l_title= NSLocalizedStringFromTable(@"No Internet access", @"GustyAppKitLocalizable", nil);
        l_messageArgument = NSLocalizedStringFromTable(@" Please try again when you are back online.", @"GustyAppKitLocalizable", nil);
    }
    NSString *l_message = [NSString stringWithFormat:NSLocalizedStringFromTable(@"It was not possible to complete the operation.%@", @"GustyAppKitLocalizable", nil), l_messageArgument];
...
+ (NSString *)saveButtonTitle {
    return NSLocalizedStringFromTable(@"Save", @"GustyAppKitLocalizable", nil);
}

+ (NSString *)cancelButtonTitle {
    return NSLocalizedStringFromTable(@"Cancel", @"GustyAppKitLocalizable", nil);
}
