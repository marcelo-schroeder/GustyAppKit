...
- (void)showViewWithMessage:(NSString *)a_message
    ...
    if (self.cancellationCompletionBlock) {
        self.hudViewController.detailText = NSLocalizedStringFromTable(@"Tap to cancel", @"GustyAppKitLocalizable", nil);
        ...
        self.hudViewController.chromeTapActionBlock = ^{
            ...
            weakSelf.hudViewController.detailText = NSLocalizedStringFromTable(@"Cancelling...", @"GustyAppKitLocalizable", nil);
