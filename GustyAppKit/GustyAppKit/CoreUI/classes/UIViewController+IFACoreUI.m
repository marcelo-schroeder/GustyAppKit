...
- (void)ifa_presentAlertControllerWithTitle:(NSString *)a_title
    ...
    UIAlertAction *continueAction = [UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"Continue", @"GustyAppKitLocalizable", nil)
                                                             style:UIAlertActionStyleDefault
                                                           handler:handler];
...
- (void)ifa_presentAlertControllerWithTitle:(NSString *)a_title message:(NSString *)a_message
    ...
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"Cancel", @"GustyAppKitLocalizable", nil)
                                                           style:UIAlertActionStyleCancel
                                                         handler:nil];
    [self ifa_presentAlertControllerWithTitle:a_title message:a_message
