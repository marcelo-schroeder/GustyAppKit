...
+ (NSString*)ifa_displayValueForNil {
    return [NSString stringWithFormat:NSLocalizedStringFromTable(@"(no %@)", @"GustyAppKitLocalizable", @"(no <ENTITY_NAME>)"), [[[IFAPersistenceManager sharedInstance].entityConfig labelForEntity:[self ifa_entityName]] lowercaseString]];
}
