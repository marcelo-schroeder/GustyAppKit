...
- (void)IFA_onReportBugButtonTap {
    ...
    [self.IFA_emailManager composeEmailWithSubject:NSLocalizedStringFromTable(@"Bug Report", @"GustyAppKitLocalizable", nil) recipient:[self IFA_supportEmailAddress] body:l_body];
}
...
- (void)IFA_onProvideFeedbackButtonTap {
    ...
    [self.IFA_emailManager composeEmailWithSubject:NSLocalizedStringFromTable(@"Feedback", @"GustyAppKitLocalizable", nil) recipient:[self IFA_supportEmailAddress] body:l_body];
}
